(function () {
  ...
  function renderAsciiFrame() {
    ...
    var z = []; // Arrat to store depth values
    ...
    // Initialize arrats with default angles
    ...
    // Update html elementwith the ascii frame
